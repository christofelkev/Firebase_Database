...
import com.chrivin.firebase.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showDialogMessage() {
        ...
        dialogMessage.setTitle("Delete All Messages")
        dialogMessage.setMessage("If click Yes , all users will be deleted" +
                "If you want to delete a specific user, you can swipe the item you want " +
                "to delete right or left")
